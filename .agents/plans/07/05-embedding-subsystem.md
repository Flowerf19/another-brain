...
| TASK-017 | Raw ONNX Runtime CPU provider: direct `sentence_embedding`, FLOAT32 `[batch,640]` finite/unit-norm validation, query-only prompt, lazy load, thread-safe single initialization, health/load-error state. | ✅ | 2026-08-04 |
