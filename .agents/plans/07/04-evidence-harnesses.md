...
| TASK-004 | Enforce the Q4 thresholds above (median cosine ≥0.99, p5 ≥0.97; macro Recall@5 ≥0.90, MRR ≥0.80, nDCG@10 ≥0.85; q4≤fp32 deltas 0.02/0.03; resource budgets). The 24-case behavior partition is deferred to the GOAL-012 gate (TASK-062) — approved revision 2026-08-04. On failure: stop or record an approved plan revision. | | |
| TASK-005 | Build checksummed judged fixtures plus deterministic 1k/10k/50k/100k stores (realistic text/scope/importance/expiry/deletion distributions, recorded seeds); write and checksum `benchmarks/reference-machine.json` before any performance run. | | |
